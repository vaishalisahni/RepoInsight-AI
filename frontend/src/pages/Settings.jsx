  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <h2 className="text-[14px] font-semibold text-slate-100" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            {title}
          </h2>
...
function Field({ label, children }) {
  return (
    <div className="space-y-1.5">
      <label className="text-[11px] font-semibold uppercase tracking-widest block" style={{ color: '#475569' }}>
        {label}
      </label>
      {children}
    </div>
...
function GitHubSection() {
  ...
  return (
    <Section
      ...
      subtitle="Required to index private repositories"
    >
    ...
    <Section icon={User} title="Profile" subtitle="Manage your account details">
      <form onSubmit={handleSave} className="space-y-4">
        ...
        <div
          ...
          style={{ background: 'rgba(16,23,41,0.5)', border: '1px solid rgba(148,163,184,0.07)' }}
        >
