...
import { Loader2, AlertCircle, GitBranch, MessageSquare, Activity, Zap, BookOpen } from 'lucide-react';
  ...
  return (
    <div className="flex overflow-hidden" style={{ height: '100%' }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        {/* Tab panels — leave room for mobile bottom nav */}
        <div
          className="flex-1 overflow-hidden min-h-0"
          style={{
            paddingBottom: activeRepoId ? 'calc(var(--mobile-nav-height, 0px) + env(safe-area-inset-bottom))' : 0,
          }}
        >
          {/* CHAT TAB */}
          {activeTab === 'chat' && (
