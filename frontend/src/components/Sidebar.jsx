  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3.5 top-16 z-20 w-7 h-7 rounded-full flex items-center justify-center transition-all hover:scale-105 shadow-lg"
        style={{
          background: '#0c1020',
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        {/* Tools — only when dashboard + repo selected */}
        {isDashboard && activeRepoId && (
          ...
          >
            {sidebarOpen && (
              <p className="text-[9px] font-bold text-slate-700 uppercase tracking-widest px-2 mb-2">
                Tools
              </p>
            )}
            {NAV_TABS.map(tab => (
        ...
        <div className="flex-1 overflow-y-auto px-2 py-2">
          {sidebarOpen && readyRepos.length > 0 && (
            <p className="text-[9px] font-bold text-slate-700 uppercase tracking-widest px-2 mb-2 mt-1">
              Repositories
            </p>
          )}
          ...
          {readyRepos.length === 0 && sidebarOpen && (
            <div className="px-2 py-6 text-center">
              <FolderGit2 className="w-7 h-7 mx-auto mb-2" style={{ color: '#1e2d45' }} />
        ...
        >
          ...
          {!sidebarOpen && user && (
            <button
              onClick={handleLogout}
              title="Sign out"
              className="w-full h-9 rounded-xl flex items-center justify-center transition-all text-slate-600 hover:text-red-400 hover:bg-red-500/10"
            >
